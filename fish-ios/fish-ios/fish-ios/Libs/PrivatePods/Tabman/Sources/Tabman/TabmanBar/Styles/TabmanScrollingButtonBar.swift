...
//        scrollView.autoPinEdgesToSuperviewEdges()
        ...
        scrollView.autoPinEdge(.right, to: .left, of: rightView)
        
//        [self.namePhoneLB autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:self.iconImageView  withOffset:10];
        
        rightView.autoSetDimension(.width, toSize: 44)
        rightView.autoPinEdge(toSuperviewEdge: .top)
        rightView.autoPinEdge(toSuperviewEdge: .bottom)
        rightView.autoPinEdge(toSuperviewEdge: .trailing)
